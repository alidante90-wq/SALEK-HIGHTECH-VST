...
juce::AudioProcessorValueTreeState::ParameterLayout SalekHightechAudioProcessor::createParameterLayout()
{
    ...
    C("lfo3_wave","LFO3 Wave",{"Sine","Triangle","Saw","Square","S&H","Custom"},0);
    ...
    F("comp_threshold","Comp Thresh",-40,0,-12); F("comp_ratio","Comp Ratio",1,20,4); F("comp_mix","Comp Mix",0,1,1);
