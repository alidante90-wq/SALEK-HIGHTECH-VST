...

    {
        ...
        // FM + macros only on modTab (LFO knobs live on lfoTab — no duplicates)
        ...
        addKnob (modTab, "macro1", "BRIGHT", C); addKnob (modTab, "macro2", "SPACE", M);
        addKnob (modTab, "macro3", "DESTROY", O); addKnob (modTab, "macro4", "WIDTH", G);
    }
